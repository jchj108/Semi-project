        ...
        <div class="row">
            <div class="col-lg-9">
            	...
            	<div class="carousel slide my-4" id="carouselExampleIndicators" data-ride="carousel" style="width: 700px;">
	                ...
	                <% 			if(j == 0){ %>
				                <div class="carousel-item active"><img class="image" src="<%= fList.get(i).getgFilePath() %>" alt="<%=j+1 %>" width='900' height='400'/></div>
	               	<% 			} %>
	                <!-- 사진 모르겠따~~~~~~~~~~~~~ -->
                	...
                	<div class="main-title">
                        ...
                        <table id="btn">
                        	<tr>
                        		...
                        		<% if( loginUser != null){ %>
                        		<input type="button" id="bookmarkBtn" class="main-button" value="즐겨찾기" onclick="location.href='<%= request.getContextPath()%>/bookmark.do'">
                        		<% } else {%>
